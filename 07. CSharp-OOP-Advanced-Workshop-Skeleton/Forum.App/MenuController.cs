namespace Forum.App
{
	...
	internal class MenuController : IMainController
	{
		...
		public MenuController(IServiceProvider serviceProvider,ILabelFactory labelFactory, IForumViewEngine viewEngine,ISession session,ICommandFactory commandFactory)
		{
